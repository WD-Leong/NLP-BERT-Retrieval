...
tmp_path = \
    "C:/Users/admin/Desktop/Data/Yelp/yelp_review_polarity_csv/"
...
tmp_pkl_file = tmp_path + "train_gpt_data.pkl"
...
tmp_pkl_file = tmp_path + "test_gpt_data.pkl"
with open(tmp_pkl_file, "wb") as tmp_file_save:
